...
class image_stitch(object):
    ...
    def image_analyis(self):
        ...
        # cv_file.release()
        # print("map is", Left_Stereo_Map_y)
        ...
        while not rospy.is_shutdown():
            ...
            if len(cond) == 4:
                ...
                imgR_gray = cv2.cvtColor(cam2, cv2.COLOR_BGR2GRAY)
                imgL_gray = cv2.cvtColor(cam1, cv2.COLOR_BGR2GRAY)
                ...
                final_img = disparity  # final image to be shown
